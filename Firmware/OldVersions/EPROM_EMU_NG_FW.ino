...
void setup() {
  pinMode( EN_RST, OUTPUT ); digitalWrite( EN_RST, HIGH );  // disable outputs to start with AD0-15 from outside
...
void load_SPIEEPROM (int eprom) {
  ...
  digitalWrite( EN_RST, HIGH ); // enable writing to SRAM / RESET traget
