...
void setup() {
  ...
  if(HW_ver[0] != 'v') {
    ...
    //
    EEPROM.put(ver_cfg, "v2.1c"); //Set this to whatever you have on the PCB, if you did the HW mod as per Errata, call it v1.6f or similar   <--------- README                                  
...
void load_SPIEEPROM (int eprom) {
  ...
  switch (eprom) {
    ...
    case 7:
      ...
      break;
     case 8:
      Serial.println(F( "->  Loading 28C64 EPROM from SPI"));
      max_size = 64; // pages of 128 bytes
      break;
    default:
