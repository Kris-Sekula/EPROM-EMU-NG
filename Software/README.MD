...
As of Nov 23 2020, it is recommended to use the 2.0rc2 version of the Python script (and 2.0rc1 version of the Arduino sketch) for the emulator. Please read the release notes.
